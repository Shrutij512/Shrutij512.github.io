...
import resume from "../resume/Shruti_Jain_resume.pdf"
import AOS from "aos";

export default function About() {

  const handleDownload = () => {
    window.open("https://drive.google.com/file/d/1pJcmYR8ktelKZeI7yFsJUbUp4fDJI41V/view?usp=sharing", '_blank');
  };
      ...
      <div>
        <div data-aos="fade-up" className=" first">
          <p id="user-detail-intro">
            Welcome to my coding realm, where I transform coffee into lines of code! <p style={{ display: 'inline-block' }} className="sauce">I'm Shruti Jain</p>
        ...
        <a
          ...
          rel="noreferrer" href={resume} download={"Shruti_Jain_resume"} id="resume-button-2" className="contact-button resume-button second-btn">
          Resume</a>
      </div>
    </section>
  );
